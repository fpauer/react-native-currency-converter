...
class Logo extends Component{
  ...
  componentDidMount() {
    ...
    this.keyboardShowListener = Keyboard.addListener(showListener, this.keyboardWillShow);
    this.keyboardHideListener = Keyboard.addListener(hideListener, this.keyboardWillHide);
  }
